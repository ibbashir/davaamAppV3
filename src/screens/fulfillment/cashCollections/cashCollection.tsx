...
const fullfilmentCashCollectionPage: React.FC = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const result = await getRequest<{ success?: boolean; data?: CashCollection[] }>(`/fulfillment/getAllCashCollection`);
  ...
  const fetchMachines = async () => {
    try {
      const result = await getRequest<{ data?: MachineInfo[] }>("/fulfillment/getMachinesWithMachineCode");
  ...
  const fetchMonthlyReport = async () => {
    try {
      ...
      const result = await postRequest<MonthlyReportResponse>(
        "/fulfillment/monthlyCashCollectionReport",
        {
          month: selectedMonth,
          year: selectedYear,
          machine_code: machineCode,
...
export default fullfilmentCashCollectionPage;