...
export default function AdminMachineVisit() {
  ...
  const fetchMachineDetails = async () => {
    const res = await postRequest(`/fulfillment/machineDetailsWithMachineCode`, { machine_code: machine.machine_code })
  ...
  const fetchChartData = async (type: "monthly" | "weekly") => {
    setLoading(true)
    try {
      const res = await postRequest<ApiResponse>("/fulfillment/BarChartMainDashboardSanitaryByMachineCode", { machine_code: machine.machine_code })
