...
export function FulfillmentTopup() {
    ...
    const fetchTopupHistory = async () => {
        try {
            setLoading(true)
            const res = await getRequest<ApiResponse>("/fulfillment/getTopUpHistory")
    ...
    const onPhoneTopupSubmit = async (data: PhoneTopupFormData) => {
        try {
            ...
            await postRequest("/fulfillment/topupUsers/phone", data);
        } catch (error) {
    ...
    const handlePhoneReset = async (data: PhoneTopupFormData) => {
        ...
        try {
            await postRequest("/fulfillment/topupUsersResetZero/phone", { phoneNumber: data.phoneNumber });
        } catch (error) {
            console.error(error);
        } finally {
            phoneForm.reset()
    ...
    const onCardTopupSubmit = async (data: CardTopupFormData) => {
        try {
            await new Promise((resolve) => setTimeout(resolve, 1000))
            await postRequest("/fulfillment/topupUsers/card", data)
        } catch (error) {
    ...
    const handleCardReset = async (data: CardTopupFormData) => {
        ...
        try {
            await postRequest("/fulfillment/topupUsersResetZero/card", { cardNumber: data.cardNumber })
        } catch (err) {
            console.log(err)
        } finally {
            cardForm.reset()
