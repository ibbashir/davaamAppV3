...
const OUTREACH_ENDPOINT = "/corporates/getOutreach"
...
export default function Outreach() {
  ...
  const handleSubmitOutreach = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editingEvent) {
        await putRequest(`/corporates/updateOutreach/${editingEvent.id}`, payload)
        toast.success("Outreach event updated")
      } else {
        await postRequest("/corporates/postOutreach", payload)
