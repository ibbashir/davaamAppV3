...
const FinanceRecentTransactions = () => {
    ...
    try {
      ...
      if (activeCategory === "butterfly") {
        const res = await getRequest<ButterflyApiResponse>(
          `/finance/getAllButterflyTransactions/${activeCategory}?page=${page}&limit=${size}`,
        );
        ...
        const res = await getRequest<OtherApiResponse>(
          `/admin/getAllButterflyTransactions/${activeCategory}?page=${page}&limit=${size}`,
        );
  ...
  const searchTransactions = async (
    ...
    try {
      ...
      if (activeCategory === "butterfly") {
        const res = await getRequest<ButterflyApiResponse>(
          `/admin/searchRecentTransactions/${activeCategory}/${searchQuery}?page=${page}&limit=${size}`,
        );
