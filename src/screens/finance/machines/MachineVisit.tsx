...
export default function FinanceMachineVisit() {
  ...
  const fetchMachineDetails = async () => {
    try {
      const res = await postRequest(`/finance/machineDetailsWithMachineCode`, {
  ...
  const fetchTransactions = async () => {
    ...
    try {
      ...
      const res = await postRequest<TransactionResponse>(
        "/finance/machineTransactionWithMachineCode",
        requestBody,
      );
  ...
  const fetchChartData = async (type: "monthly" | "weekly") => {
    ...
    try {
      const res = await postRequest<ApiResponse>(
        "/finance/BarChartMainDashboardSanitaryByMachineCode",
        { machine_code: machine.machine_code },
      );
  ...
  const exportToCSV = async () => {
    ...
    try {
      ...
      const csvData = await postRequest(
        "/finance/machine-transaction-csv",
        requestBody,
      );
  ...
  return (
    <div>
      <SiteHeader title="🌍 Finance Machine Dashboard" />
