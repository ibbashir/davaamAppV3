...
export default function FinanceMachineVisit() {
  ...
  const fetchMachineDetails = async () => {
    const res = await postRequest(`/finance/machineDetailsWithMachineCode`, { machine_code: machine.machine_code })
  ...
  const fetchChartData = async (type: "monthly" | "weekly") => {
    setLoading(true)
    try {
      const res = await postRequest<ApiResponse>("/finance/BarChartMainDashboardSanitaryByMachineCode", { machine_code: machine.machine_code })
