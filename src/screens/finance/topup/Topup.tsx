...
export function FinanceTopup() {
    ...
    const fetchTopupHistory = async () => {
        try {
            setLoading(true)
            const res = await getRequest<ApiResponse>("/finance/getTopUpHistory")
    ...
    const onPhoneTopupSubmit = async (data: PhoneTopupFormData) => {
        try {
            ...
            await postRequest("/finance/topupUsers/phone", data);
        } catch (error) {
    ...
    const handlePhoneReset = async (data: PhoneTopupFormData) => {
        ...
        try {
            await postRequest("/finance/topupUsersResetZero/phone", { phoneNumber: data.phoneNumber });
        } catch (error) {
            console.error(error);
        } finally {
            phoneForm.reset()
    ...
    const onCardTopupSubmit = async (data: CardTopupFormData) => {
        try {
            await new Promise((resolve) => setTimeout(resolve, 1000))
            await postRequest("/finance/topupUsers/card", data)
        } catch (error) {
    ...
    const handleCardReset = async (data: CardTopupFormData) => {
        ...
        try {
            await postRequest("/finance/topupUsersResetZero/card", { cardNumber: data.cardNumber })
        } catch (err) {
            console.log(err)
        } finally {
            cardForm.reset()
